...
const LoginWithMetaMask = () => {
    ...
    const loginWithMetaMask = async () => {
        try {
            ...
            if (!window.ethereum) return setLoading("Please install MetaMask or use the MetaMask browser !")
            ...
            {modal && <div className={css.modal__container}>
                <div className={css.modal__block}>
                    <div className={css.register__header}>
                        {EN ? "Please enter your email address, it will only be used once " : "Будь ласка, введіть свою електронну адресу, вона буде використана лише один раз"}
                    </div>
