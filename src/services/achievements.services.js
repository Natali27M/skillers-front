...
export const achievementsServices = {
    ...
    getLeaderBordByQueryTen: (pageNumber, query) => axiosServices.get(urls.achievementPaginatedTen + pageNumber + '&filters[userName][$contains]=' + query).then(value => value.data),
