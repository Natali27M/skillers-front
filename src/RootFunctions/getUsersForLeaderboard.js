export default function getUsersForLeaderboard(leaderboard) {
    console.log(leaderboard.data);
    const as = leaderboard.data;
    // leaderboard.data.map(value => console.log(value))
    // const users = [];
    // for (const a of as) {
    //     console.log(a);
          // users.push(leaderboard.attributes.userId)
    // }
    // console.log(users,'users');
}
//
// export default function getUsersForLeaderboard() {
